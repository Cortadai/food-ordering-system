...
import com.food.ordering.system.order.service.dataaccess.order.entity.OrderAddresEntity;
...
public class OrderDataAccessMapper {
    ...
    private StreetAddress addressEntityToDeliveryAddress(OrderAddresEntity address) {
    ...
    private OrderAddresEntity deliveryAddressToAddressEntity(StreetAddress streetAddress) {
        return OrderAddresEntity.builder()
