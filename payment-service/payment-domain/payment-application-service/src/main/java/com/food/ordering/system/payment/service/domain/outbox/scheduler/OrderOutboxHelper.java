...
public class OrderOutboxHelper {
    ...
    public Optional<OrderOutboxMessage> getCompleteOrderOutboxMessageBySagaIdAndPaymentStatus(
    ...
    private String createPayload(OrderEventPayload payload) {
        try {
            ...
            log.error("Could not create OrderEventPayload for order id: {}", payload.getOrderId());
            throw new PaymentDomainException("Could not create OrderPaymentEventPayload for order id: " +
